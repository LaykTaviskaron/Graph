...
namespace Graph
{
	public class DirectedAdjacencyMatrix : IAdjacencyMatrix
	{
		private bool[][] _matrix;

		public DirectedAdjacencyMatrix(int verticesNumber)
		{
			if (verticesNumber < 1)
			{
		...
		public DirectedAdjacencyMatrix(int verticesNumber, bool[][] edges)
		{
			if (edges == null)
			{
