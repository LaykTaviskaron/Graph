...
namespace Graph
{
	public class UndirectedAdjacencyList<T> : IAdjacencyList<T>
	{
		...
		public UndirectedAdjacencyList(string[][] graph)
		{
			if (graph == null)
			{
		...
		public void AddEdge(string sourceName, string destinationName)
		{
			...
			GetVertexEdges(sourceName).Add(destinationVertex);
			GetVertexEdges(destinationName).Add(sourceVertex);
		}
		...
		public void RemoveEdge(string sourceName, string destinationName)
		{
			...
			GetVertexEdges(destinationName).Remove(sourceVertex);
		}
